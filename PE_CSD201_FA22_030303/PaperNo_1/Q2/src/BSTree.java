...
//            return;
//        }
        House boo = new House(xOwner, xPrice, xColor);
        if (isEmpty()) {
            root = new Node(boo);
            return;
        } else {
    ...
    void f4() throws Exception {
         ...
         * method is 
         * (H,1,7) (K,4,6) (J,5,5) (I,3,9) (F,2,3) (G,7,8) (D,6,1)
         * (E,9,4) (C,8,2) 
         * (H,1,8) (K,4,7) (J,5,5) (I,3,9) (F,2,3) (G,7,9)
         * (D,6,1) (E,9,5) (C,8,2)
         */
        //---------------------------------------------------------------------------------------
        //------ Start your code here------------------------------------------------------------
    ...
    public void preOrder2(ArrayList<Node> list, Node p) throws Exception {
        ...
        preOrder2(list, p.left);
        preOrder2(list, p.right);
    }
