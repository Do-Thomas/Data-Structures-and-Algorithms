...
public class Maze_V2 {
    ...
    public boolean loadFromFile(String filename) {
        ...
        try{
            ...
            for(int i=0; i<list.size(); i++) { //Creating cells 
                 ...
                 for(int j=0; j<cols; j++) {  //Creating cells in row i
    ...
    public boolean solve() {
        LinkedList<Cell_V2> stack = new LinkedList();  //Initiatinfg a stack
        Cell_V2 curCell=this.entryCell; //Starting at the entry of maze
